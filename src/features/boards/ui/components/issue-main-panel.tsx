...
export default function IssueMainPanel({ issue, onUpdate }: { issue: any; onUpdate: (data: any) => void }) {
      ...
      <div>
        {!editingSummary ? (
          ...
          <div className="flex items-start gap-2">
            <Input value={summary} onChange={(e) => setSummary(e.target.value)} className="text-3xl font-semibold mb-2" />
