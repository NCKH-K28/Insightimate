...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [threadBubbles, setThreadBubbles] = React.useState<Record<string, HTMLElement[]>>({});
  ...
  const removeThreadBubble = React.useCallback((threadIdOrElement: string | HTMLElement) => {
