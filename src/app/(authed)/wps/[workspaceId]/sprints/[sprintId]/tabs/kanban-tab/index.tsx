...
const formatField = (field: ProjectField) => {
  return { ...field, color: field.color ?? undefined, iconURL: field.iconURL ?? undefined };
};
...
export default function KanbanTabV3({ params, issues }: KanbanTabV3Props) {
  ...
  if (columnsPending) return <KanbanTabSkeleton />;
  return (
