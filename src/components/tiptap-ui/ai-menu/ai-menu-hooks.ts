...
import { findPrioritizedAIElement, cleanupFallbackAnchors } from './ai-menu-utils';
import type { AiMenuState, AiMenuStateContextValue, AiMenuPosition } from './ai-menu-types';

export const AiMenuStateContext = React.createContext<AiMenuStateContextValue | null>(null);
...
export function useTextSelectionTracker({
  ...
  }, [editor, aiGenerationActive, showMenuAtElement, setMenuVisible, onSelectionChange, prevent]);
}
