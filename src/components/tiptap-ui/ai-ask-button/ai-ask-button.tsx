...
import { AI_ASK_SHORTCUT_KEY, useAiAsk } from '@/components/tiptap-ui/ai-ask-button';
 ...
 */
export const AiAskButton = React.forwardRef<HTMLButtonElement, AiAskButtonProps>(
