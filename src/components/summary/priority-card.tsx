  ...
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={priorityChartConfig}>
          <BarChart accessibilityLayer data={data} layout="vertical" margin={{ left: 0 }}>
            <YAxis dataKey="priority" type="category" tickLine={false} tickMargin={10} axisLine={false} tickFormatter={(v) => String(v)} />
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        ...
        <div className="text-muted-foreground leading-none">Showing total issues grouped by priority</div>
      </CardFooter>
    </Card>
  )
}
